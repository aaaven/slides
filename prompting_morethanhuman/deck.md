...
#### 1st Prompting as Desining: Crafting, Steering, and Collaborating with LLMs

---

#### 2nd Implementing **Post-Anthropocentric** and **Non-human Perspective**
...
5. Documentation and Archive with Ethics

---

### What is "Design (with) LLMs"?
...
- Build prompts like create a **design brief**<!-- .element: class="fragment grow highlight-current-red" -->
...
#### How? Common Prompt Tuning Strategies
...
- Encourages **empathy** and goes beyond antropocentric thinking and perspectives

----

In other word, for more-than-human design:
...
> “Now, review the previous descriptions and prompts.  
...
## How to better "design" the Prompt?

  
- Iterate with strategies and **document the process**  
...
Together, they turn prompting into **designing process** for **collaborative thinking** and **relational thinking**.


---


### 💬 Prompting as a Design Process? Why?
...
### 🌍 Perspective Switching (For More-than-Huamn Layer)
